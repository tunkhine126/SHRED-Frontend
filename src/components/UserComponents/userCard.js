...
import { Card, ListGroup, Col, Image, Button } from 'react-bootstrap';
        ...
        <Card style={{ width: '20rem' }} >
            ...
            <Card.Body> 
              ...
              Location: {this.props.user.location}
                ...
                <Popup trigger={<Button> Edit Profile</Button>} position="right center" style={{ width: '18rem' }} closeOnDocumentClick>
                  <EditUserForm/>
                </Popup>
